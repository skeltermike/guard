 ...
 */
this.constructor.DATA_KEY = undefined;
(function (global, factory) {
  ...
  const BSC_PREFIX_REGEX$1 = new RegExp("(^|\\s)" + CLASS_PREFIX$1 + "\\S+", 'g');
  ...
  var Popover =
    ...
    function (_Tooltip) {
      ...
      _proto._cleanTipClass = function _cleanTipClass() {
        var $tip = $(this.getTipElement());
        var tabClass = $tip.attr('class').match(BSC_PREFIX_REGEX$1);
